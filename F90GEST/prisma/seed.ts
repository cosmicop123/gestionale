...
async function main() {
  ...
  const parametriDefault: Array<{ chiave: string; valore: string; descrizione: string }> = [
    ...
    {
      chiave: "contabilita.mappatura_categorie_rendiconto",
      ...
      descrizione:
        "Mappatura (JSON) di ogni categoria di prima nota su una delle 5 sezioni A-E del rendiconto per cassa (Mod. D, DM 5/3/2020). Proposta di default: verificare con il proprio consulente prima di approvare il rendiconto.",
    },
    {
